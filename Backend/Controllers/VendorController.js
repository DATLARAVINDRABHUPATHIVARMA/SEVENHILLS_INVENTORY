...
const addVendor = async (req, res) => {
  try {
    ...
    const newVendor = new Vendor({ vendorID, vendorName, vendorEmail, vendorPhone, vendorGST, vendorAddress, vendorDescription });
...
const updateVendor = async (req, res) => {
  try {
    ...
    const updatedVendor = await Vendor.findByIdAndUpdate(id, { vendorID, vendorName, vendorEmail, vendorPhone, vendorGST, vendorAddress, vendorDescription }, { new: true });
