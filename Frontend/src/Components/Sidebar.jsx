...
const Sidebar = () => {
  const menuItems = [
    ...
    { name: 'Vendors', path: '/admin-dashboard/vendors', icon:<FaTruck />, isParent: false },
  ...
  return (
    <div className='flex flex-col h-screen bg-black text-white w-16 md:w-64 fixed'>
      <div className="h-16 flex flex-items justify-center">
        <span className='hidden md:block text-xl font-bold'>Seven Hills Inventory</span>
        <span className='md:hidden text-xl font-bold'>Store</span>
      </div>
      <div>
